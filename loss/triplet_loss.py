...
def batch_all_triplet_loss(labels, embeddings, margin, squared=False):
    ...
    layers["all_triplet_loss"] = triplet_loss
    layers["fraction_postive_triplets"] = fraction_postive_triplets
    return layers
...
def batch_hard_triplet_loss(labels, embeddings, margin, squared=False):
    ...
    triplet_loss = tf.reduce_mean(triplet_loss, name="triplet_loss")
    return triplet_loss
